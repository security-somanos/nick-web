...
import { User, Star, Award, Mic, ChevronDown } from "lucide-react"
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@/components/ui/accordion"

export function ExperienceAccordion() {
  return (
    <section id="experience" className="space-y-8">
      {/* Mobile Accordion - All sections */}
      <div className="md:hidden">
        <Accordion type="multiple" className="space-y-4">
          <AccordionItem value="about" className="border border-[#ffffff1a] rounded-2xl">
            ...
            <AccordionContent className="px-4 pb-4">
              <div className="bg-[#101010] rounded-2xl p-4">
          ...
          <AccordionItem value="highlights" className="border border-[#ffffff1a] rounded-2xl">
            <AccordionTrigger className="px-4 py-3 hover:no-underline">
              <div className="flex items-center gap-3">
          ...
          <AccordionItem value="media" className="border border-[#ffffff1a] rounded-2xl">
            <AccordionTrigger className="px-4 py-3 hover:no-underline">
              <div className="flex items-center gap-3">
          ...
          <AccordionItem value="speaking" className="border border-[#ffffff1a] rounded-2xl">
            <AccordionTrigger className="px-4 py-3 hover:no-underline">
              <div className="flex items-center gap-3">
      ...
      {/* Desktop/Tablet view - Always visible sections */}
